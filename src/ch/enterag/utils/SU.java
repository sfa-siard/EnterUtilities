...
------------------------------------------------------------------------
The class ch.enterag.utils.BU is free software; you can redistribute it
and/or modify it under the terms of the GNU General Public License 
version 2 or later as published by the Free Software Foundation.

ch.enterag.utils.BU is distributed in the hope that it will 
...
If you have a need for licensing ch.enterag.utils.BU without 
  ...
  private static byte[] putEncodedCharArray(char[] ac, int iOffset, int iLength, String sEncoding)
	{
  	...
  	catch (UnsupportedEncodingException uee) { System.out.println(uee.getClass().getName()+":"+uee.getMessage());}
